...
- `packet-loss-rate` is an estimated rate of UDP packets loss for the window of last `mountpoint_info_interval` seconds as regular stats
- `packet-loss-count` is a count of UDP packets loss for a lifetime of the stream
